...
OMPI_params="$OMPI_params -x MP_BENCH_SIZE -x MP_BENCH_GPU_BUFFERS"
OMPI_params=""
...
MVAPICH_params="$MVAPICH_params -genv MP_BENCH_ENABLE_DEBUG -genv MP_BENCH_ENABLE_VALIDATION -genv MP_BENCH_KERNEL_TIME"
MVAPICH_params="$MVAPICH_params -genv MP_BENCH_COMM_COMP_RATIO -genv MP_BENCH_CALC_SIZE -genv MP_BENCH_USE_CALC_SIZE"
MVAPICH_params="$MVAPICH_params -genv MP_BENCH_STEPS_PER_BATCH -genv MP_BENCH_BATCHES_INFLIGHT -genv MP_ENABLE_UD"
MVAPICH_params="$MVAPICH_params -genv MP_BENCH_SIZE -genv MP_BENCH_GPU_BUFFERS"
