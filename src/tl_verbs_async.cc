#include "tl_verbs_async.hpp"

int TL::Verbs_Async::verbs_check_gpu_error()
{
        int ret = MP_SUCCESS;
...
uint32_t * TL::Verbs_Async::verbs_client_last_tracked_id_ptr(verbs_client_async_t client, verbs_request_async_t req)
{
return &client->last_tracked_id[verbs_type_to_flow((mp_req_type_t)req->type)]; //mp_req_to_flow
}

void TL::Verbs_Async::verbs_client_track_posted_stream_req(verbs_client_async_t client, verbs_request_async_t req, mp_flow_t flow)
{    
...
void TL::Verbs_Async::verbs_client_track_waited_stream_req(verbs_client_async_t client, verbs_request_async_t req, mp_flow_t flow)
{
...
int TL::Verbs_Async::verbs_client_can_poll(verbs_client_async_t client, mp_flow_t flow)
{
...
int TL::Verbs_Async::verbs_progress_posted_list (mp_flow_t flow)
{
        int i, ret = 0;
...
void TL::Verbs_Async::verbs_env_vars()
{
        char *value = NULL;
...
//=================================================== OVERRIDE PROTECTED ==============================================================
int TL::Verbs_Async::verbs_progress_single_flow(mp_flow_t flow)
{
        int i, ne = 0, ret = 0;
...
int TL::Verbs_Async::verbs_post_recv(verbs_client_async_t client, verbs_request_async_t req)
{
...
int TL::Verbs_Async::verbs_post_send(verbs_client_async_t client, verbs_request_async_t req, cudaStream_t stream, int async, int event_sync, int no_wait)
{
        int progress_retry=0, ret=0, ret_progress=0;
...
void TL::Verbs_Async::verbs_allocate_requests()
{
        int i;
...
verbs_request_async_t  TL::Verbs_Async::verbs_get_request()
{
        verbs_request_async_t req = NULL;
...
verbs_request_async_t TL::Verbs_Async::verbs_new_request(verbs_client_async_t client, mp_req_type_t type, mp_state_t state) //, struct CUstream_st *stream)
{
...
//=================================================== OVERRIDE PUBLIC ==============================================================
int TL::Verbs_Async::createEndpoints() {
        int ret, i;
        int gds_flags;
...
int TL::Verbs_Async::updateEndpoints() {
...
int TL::Verbs_Async::pt2pt_nb_recv(void * buf, size_t size, int peer, mp_region_t * mp_reg, mp_request_t * mp_req) {
        int ret = 0;
        verbs_request_async_t req = NULL;
...
int TL::Verbs_Async::pt2pt_nb_recvv(struct iovec *v, int nvecs, int peer, mp_region_t * mp_reg, mp_request_t * mp_req) {
        int ret = 0;
        verbs_request_async_t req = NULL;
        verbs_region_t reg = (verbs_region_t) *mp_reg;
        verbs_client_async_t client = &clients_async[client_index[peer]];
...
int TL::Verbs_Async::pt2pt_nb_send(void * buf, size_t size, int peer, mp_region_t * mp_reg, mp_request_t * mp_req) {
        int ret = 0;
        verbs_request_async_t req = NULL;
        verbs_region_t reg = (verbs_region_t) *mp_reg;
        verbs_client_async_t client = &clients_async[client_index[peer]];
...
int TL::Verbs_Async::pt2pt_nb_sendv(struct iovec *v, int nvecs, int peer, mp_region_t * mp_reg, mp_request_t * mp_req)
{
        int ret = 0;
        verbs_request_async_t req = NULL;
        verbs_region_t reg = (verbs_region_t) *mp_reg;
...
int TL::Verbs_Async::wait_all(int count, mp_request_t *req_)
{
...
int TL::Verbs_Async::onesided_window_create(void *addr, size_t size, mp_window_t *window_t)
{
        int i, peer;
...
int TL::Verbs_Async::onesided_nb_put (void *buf, int size, mp_region_t *mp_reg, int peer, size_t displ, mp_window_t *window_t, mp_request_t *mp_req, int flags) 
{
        int ret = 0;
...
int TL::Verbs_Async::onesided_nb_get(void *buf, int size, mp_region_t *mp_reg, int peer, size_t displ, mp_window_t *window_t, mp_request_t *mp_req) 
{
        int ret = 0;
        verbs_request_async_t req;
        verbs_region_t reg = (verbs_region_t) *mp_reg;
...
int TL::Verbs_Async::setup_sublayer(int par1) 
{
        int version, ret;
...
//==================================================== ASYNC ===============================================================TL::Verbs_Async::
int TL::Verbs_Async::pt2pt_nb_send_async(void * buf, size_t size, int peer, mp_region_t * mp_reg, mp_request_t * mp_req, asyncStream stream)
{
        int ret = 0;
        verbs_request_async_t req = NULL;
        verbs_region_t reg = (verbs_region_t) *mp_reg;
...
//mp_isendv_on_stream
int TL::Verbs_Async::pt2pt_nb_sendv_async (struct iovec *v, int nvecs, int peer, mp_region_t * mp_reg, mp_request_t * mp_req, asyncStream stream)
{
        int ret = 0;
        verbs_request_async_t req;
        verbs_region_t reg = (verbs_region_t )*mp_reg;
...
//mp_send_on_stream
int TL::Verbs_Async::pt2pt_b_send_async(void *buf, int size, int peer, mp_region_t * mp_reg,  mp_request_t *mp_req, asyncStream stream)
{
        int ret = 0;
        verbs_request_async_t req = NULL;
        verbs_region_t reg = (verbs_region_t) *mp_reg;
...
//mp_send_prepare
int TL::Verbs_Async::pt2pt_send_prepare(void *buf, int size, int peer, mp_region_t * mp_reg, mp_request_t *mp_req)
{
        int ret = 0;
        verbs_request_async_t req;
        verbs_region_t reg = (verbs_region_t )*mp_reg;
...
//mp_sendv_prepare
int TL::Verbs_Async::pt2pt_sendv_prepare(struct iovec *v, int nvecs, int peer, mp_region_t * mp_reg, mp_request_t *mp_req)
{
        int ret = 0;
        verbs_request_async_t req;
        verbs_region_t reg = (verbs_region_t )*mp_reg;
...
int TL::Verbs_Async::pt2pt_b_send_post_async(mp_request_t *mp_req, asyncStream stream)
{
        return pt2pt_b_send_post_all_async(1, mp_req, stream);
}

//mp_send_post_all_on_stream
int TL::Verbs_Async::pt2pt_b_send_post_all_async(int count, mp_request_t *mp_req, asyncStream stream)
{
...
int TL::Verbs_Async::pt2pt_nb_send_post_async(mp_request_t *mp_req, asyncStream stream)
{
        return pt2pt_nb_send_post_all_async(1, mp_req, stream);
}

//mp_isend_post_all_on_stream
int TL::Verbs_Async::pt2pt_nb_send_post_all_async(int count, mp_request_t *mp_req, asyncStream stream)
{
...
int TL::Verbs_Async::progress_requests (int count, mp_request_t *req_)
{
        int r = 0, ret = 0;
...
/*poll until completion*/
        while (r < count) {
                ...
                if (!verbs_req_valid(req)) {
                        mp_err_msg(oob_rank, "invalid req:%p status:%d id=%d peer=%d type=%d, going on anyway\n", 
                                req, req->status, req->id, req->peer, req->type);
                }
...
int TL::Verbs_Async::wait_word_async(uint32_t *ptr, uint32_t value, int flags, asyncStream stream)
{
        int ret = MP_SUCCESS;
...
int TL::Verbs_Async::wait_async(mp_request_t *mp_req, asyncStream stream)
{
...
int TL::Verbs_Async::onesided_nb_put_async(void *buf, int size, mp_region_t * mp_reg, int peer, size_t displ,
...
//mp_put_prepare
int TL::Verbs_Async::onesided_put_prepare (void *buf, int size, mp_region_t * mp_reg, int peer, size_t displ,
...
int TL::Verbs_Async::onesided_nb_put_post_async(mp_request_t *mp_req, asyncStream stream)
{
...
int TL::Verbs_Async::onesided_nb_put_post_all_async (int count, mp_request_t *mp_req, asyncStream stream)
{
        int i, ret = 0;
...
int TL::Verbs_Async::onesided_nb_get_async(void *buf, int size, mp_region_t * mp_reg, int peer, size_t displ,
...
int TL::Verbs_Async::descriptors_queue_alloc(mp_comm_descriptors_queue_t *pdq)
{
        int ret = ENOMEM;
        assert(pdq);
...
int TL::Verbs_Async::descriptors_queue_free(mp_comm_descriptors_queue_t *pdq)
{
        int ret = 0;
        assert(pdq);
...
int TL::Verbs_Async::descriptors_queue_add_send(mp_comm_descriptors_queue_t *pdq, mp_request_t *mp_req)
{
        int ret = 0;
        assert(pdq);
        verbs_comm_desc_queue_t dq = (verbs_comm_desc_queue_t) *pdq;
...
int TL::Verbs_Async::descriptors_queue_add_wait_send(mp_comm_descriptors_queue_t *pdq, mp_request_t *mp_req)
{
        int ret = 0;
        assert(pdq);
        verbs_comm_desc_queue_t dq = (verbs_comm_desc_queue_t) *pdq;
...
int TL::Verbs_Async::descriptors_queue_add_wait_recv(mp_comm_descriptors_queue_t *pdq, mp_request_t *mp_req)
{
        int ret = 0;
        assert(pdq);
        verbs_comm_desc_queue_t dq = (verbs_comm_desc_queue_t) *pdq;
...
int TL::Verbs_Async::descriptors_queue_add_wait_value32(mp_comm_descriptors_queue_t *pdq, uint32_t *ptr, uint32_t value, int flags)
{
        int ret = 0;
        assert(pdq);
        verbs_comm_desc_queue_t dq = (verbs_comm_desc_queue_t) *pdq;
...
int TL::Verbs_Async::descriptors_queue_add_write_value32(mp_comm_descriptors_queue_t *pdq, uint32_t *ptr, uint32_t value)
{
        int ret = 0;
        assert(pdq);
        verbs_comm_desc_queue_t dq = (verbs_comm_desc_queue_t) *pdq;
...
int TL::Verbs_Async::descriptors_queue_post_async(cudaStream_t stream, mp_comm_descriptors_queue_t *pdq, int flags)
{
        int ret = 0;
        assert(pdq);
        verbs_comm_desc_queue_t dq = (verbs_comm_desc_queue_t) *pdq;
...
// track req
        assert(req->status == MP_PREPARED);
        if (use_event_sync) {
                mp_err_msg(oob_rank, "unsupported call in async event mode\n"); 
                ret = MP_FAILURE;
                goto out;
        }
        req->status = MP_PENDING_NOWAIT;
