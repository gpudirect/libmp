/*
  https://www.intel.com/content/dam/support/us/en/documents/network/omni-adptr/sb/Intel_PSM2_PG_H76473_v1_0.pdf
...
void write_epid_to_file(psm2_epid_t myepid) {
  ...
  if (!fp){
    fprintf(stderr, "Exiting, couldn't write server's epid mapping file: ");
